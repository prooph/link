...
namespace Gingerwork\Monitor\GingerPlugin;
 ...
 *
 * This class is a Ginger\Environment\Plugin and acts as a listener for workflow processor events and process events
 * which are persisted by the event store. Main goal is to populate a read model with status information about triggered
 * processes.
 *
 * @package Gingerwork\Monitor\GingerPlugin
 * @author Alexander Miertsch <kontakt@codeliner.ws>
 */
final class ProcessLogListener implements Plugin
{
    const PLUGIN_NAME = 'gingerwork.monitor.process_log_listener';
